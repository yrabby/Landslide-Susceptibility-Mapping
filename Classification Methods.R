...
plot(Volume)
#Logistic Regression
Landslide.fit=glm(ï..Y~.  , data=Data, family=binomial)
summary(Landslide.fit)
coef(Landslide.fit)
#Logistic Regression Modified 1
Landslide.fit1=glm(ï..Y~.-Change  , data=Data, family=binomial)
summary(Landslide.fit1)
coef(Landslide.fit1)
#Logistic Regression Modified 2
Landslide.fit2=glm(ï..Y~.-Change -SPI -TWI  , data=Data, family=binomial)
